...
`Python` `SQL` `Flask` `REST APIs` `HTML/CSS` `JSON`

**Data & Machine Learning**
`Pandas` `NumPy` `Scikit-learn` `Matplotlib` `ETL` `Predictive Modeling` `Feature Engineering` `EDA` `Tableau` `Jupyter`

**Databases & Infrastructure**
`PostgreSQL` `MongoDB` `SQLite` `Elasticsearch` `Docker` `Linux` `Git` `AWS (S3, EC2)`
...
I am a May 2026 graduate actively seeking **Data Engineer, Data Scientist, Data Analyst, Backend Developer, and Software Engineer** roles  **globally**.

[![LinkedIn](https://img.shields.io/badge/LinkedIn-Anesu%20Ruzvidzo-blue?style=flat&logo=linkedin)](https://www.linkedin.com/in/anesuruzvidzo)
[![Email](https://img.shields.io/badge/Email-anesuruzvidzo1%40gmail.com-red?style=flat&logo=gmail)](mailto:anesuruzvidzo1@gmail.com)
